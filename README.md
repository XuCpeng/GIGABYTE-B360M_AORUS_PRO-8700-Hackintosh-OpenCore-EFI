...
**EFI macOS 12：** OC-0.7.5-RELEASE，适配 macOS 12.1 Monterey Beta (21C5021h)。此 EFI 应该也适用于 macOS 11，但 macOS 11 的 EFI 不适用 macOS12。
...
- 强烈建议**使用DP输出**
- 引导： OpenCore RELEASE
- 系统： macOS 12.1 Monterey Beta (21C5021h)
- CPU： i7-8700 睿频正常
